...
export const CLUES: Clue[] = [
  ...
  { id: 7, tier: 2, title: "The Lost Sequence", hint: "The years are out of order. Start at the present, then loop back to the beginning, and return to the middle.", location: "journey", prerequisite: 6 },
  ...
  { id: 14, tier: 4, title: "The Passphrase", hint: "The itch that opens every door.", location: "terminal", prerequisite: 13 },
